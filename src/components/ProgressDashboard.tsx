    ...
    <div className="relative w-full lg:w-[480px] h-auto lg:h-[450px] bg-[#f2eae5] rounded-3xl shadow-sm p-4 sm:p-[18px] flex flex-col justify-between [font-family:'Aeonik_Pro',sans-serif]">
      ...
      <div className="flex justify-center mt-4 mb-2">
        ...
        >
          ...
          {[0, 25, 50, 100].map((mark: number) => {
            const angle = (mark / 100) * 180;
            const textPos = polarToCartesian(
              cx,
              cy,
              radius + strokeWidth / 2 + 20,
              angle
            );
            return (
              <text
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-2 text-center mb-2">
        <div>
          <div className="text-xl sm:text-2xl font-bold text-[#292D32]">
            {totalProjects}
          </div>
        ...
        <div>
          <div className="text-xl sm:text-2xl font-bold text-[#1A932E]">
            {completed}
          </div>
          <div className="text-[11px] sm:text-xs text-gray-500 mt-1">
            Completed
        ...
        <div>
          <div className="text-xl sm:text-2xl font-bold text-[#DFA510]">
            {delayed}
          </div>
          <div className="text-[11px] sm:text-xs text-gray-500 mt-1">
            Delayed
        ...
        <div>
          <div className="text-xl sm:text-2xl font-bold text-[#E65F2B]">
            {ongoing}
          </div>
          <div className="text-[11px] sm:text-xs text-gray-500 mt-1">
            On going
