...
export default function ProgressDashboard() {
  ...
  return (
    <div className="relative w-[480px] h-[450px] bg-[#f2eae5] rounded-3xl shadow-sm p-[18px] flex flex-col justify-between [font-family:'Aeonik_Pro',sans-serif]">
      
      <div className="flex items-center justify-between mb-2 relative">
        <h2 className="text-[16px] font-bold text-[#292D32]">Overall Progress</h2>
      ...
      <div className="grid grid-cols-4 gap-2 text-center mb-2">
        <div>
          <div className="text-2xl font-bold text-[#292D32]">{totalProjects}</div>
          <div className="text-xs text-gray-500 mt-1">Total projects</div>
        </div>
        <div>
          <div className="text-2xl font-bold text-[#1A932E]">{completed}</div>
          <div className="text-xs text-gray-500 mt-1">Completed</div>
        </div>
        <div>
          <div className="text-2xl font-bold text-[#DFA510]">{delayed}</div>
          <div className="text-xs text-gray-500 mt-1">Delayed</div>
        </div>
        <div>
          <div className="text-2xl font-bold text-[#E65F2B]">{ongoing}</div>
